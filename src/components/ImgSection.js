...
function ImgSection() {
    return (
        <div className='relative text-white bg-terciary'>
            {/* <div className='h-32 mb-5 bg-printed-terciary' /> */}
            <div className='absolute top-0 flex w-full bg-center h-1/6 bg-printed-terciary' />
            <div className='flex flex-col items-center justify-center w-full pt-44 md:pt-52 sm:bg-primary'>
                ...
                <div className='grid w-2/3 grid-cols-2 gap-4 mb-16 md:w-1/2 h-1/2'>
